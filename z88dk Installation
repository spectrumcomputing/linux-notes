...
This guide is for getting started with installing the z88dk C development suite in Ubuntu 20.04. The target machine here is the Sinclair ZX Spectrum. I'm assuming that you are reasonably proficient in using the command line.
